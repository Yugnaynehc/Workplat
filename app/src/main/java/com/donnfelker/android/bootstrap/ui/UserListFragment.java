        ...
        return new ThrowableLoader<List<User>>(getActivity(), items) {
            ...
            public List<User> loadData() throws Exception {
                ...
                try {
                    ...
                    User one = new User();
                    one.setFirstName("XX变电站");
                    one.setLastName("全面巡检");
                    User two = new User();
                    two.setFirstName("XX变电站");
                    two.setLastName("日常巡检");
                    User three = new User();
                    three.setFirstName("XX变电站");
                    three.setLastName("熄灯巡检");
                    User four = new User();
                    four.setFirstName("XX变电站");
                    four.setLastName("红外线测试");
                    User five = new User();
                    five.setFirstName("XX变电站");
                    five.setLastName("特殊巡检");
                    latest.add(0, one);
                    latest.add(1, two);
                    latest.add(2, three);
                    latest.add(3, four);
